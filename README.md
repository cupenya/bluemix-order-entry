...
## Tutorial to Track Activities in Cupenya Insights

After deploying it visit your app at <app-name>.mybluemix.net and follow the rest of this tutorial to see how it is connected to Cupenya Insights
